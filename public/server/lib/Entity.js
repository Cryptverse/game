...
export class Mob extends Entity {
    ...
    destroy() {
        ...
        const tables = [
            {minRarity: -2, maxRarity: 0, median: -1},
            {minRarity: -1, maxRarity: 1, median: 0},
            {minRarity: 0, maxRarity: 2, median: 1},
            {minRarity: 1, maxRarity: 3, median: 2},
            {minRarity: 2, maxRarity: 4, median: 3},
            {minRarity: 3, maxRarity: 5, median: 4},
            {minRarity: 4, maxRarity: 6, median: 5},
            {minRarity: 5, maxRarity: 7, median: 6},
            {minRarity: 6, maxRarity: 8, median: 7},
            {minRarity: 7, maxRarity: 9, median: 8},
            {minRarity: 8, maxRarity: 10, median: 9},
            ...
            if (damager.clientID > 0) {
                ...
                if (client) {
                    ...
                    for (const drop of mobConfigs[this.index].drops) {
                        const weight = []
                        let total = 0;
                        for (let i = 0; i < 1 + (table.maxRarity - table.minRarity); i++) weight.push(Math.pow(drop.chance, i + table.median) * multi[i]), total += (Math.pow(drop.chance, i + table.median) * multi[i]);
