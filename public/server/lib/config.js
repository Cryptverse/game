...
newPetals1 = [
    new PetalConfig("Small Bullet", 0, 12, 0).setProjectile().setSize(1).setDrawing(
        new Drawing().addAction("beginPath").addAction("arc", 0, 0, 1, -Math.PI/2, Math.PI/2).addAction("lineTo", -1, 1).addAction("lineTo", -1, -1).addAction("lineTo", 0, -1).addAction("fill", "#FFE344").addAction("stroke", "#FFE344", 0.4, 0.3).addAction("closePath")
    ).setDescription("[object null object]"),
    new PetalConfig("Medium Bullet", 0, 18, 0).setProjectile().setSize(1.5).setDrawing(
        new Drawing().addAction("beginPath").addAction("moveTo", 1.25/1.5, 0/1.5).addAction("quadraticCurveTo", 1.25/1.5, 1/1.5, -1.25/1.5, 1/1.5).addAction("lineTo", -1.25/1.5, -1/1.5).addAction("quadraticCurveTo", 1.25/1.5, -1/1.5, 1.25/1.5, 0/1.5).addAction("fill", "#FFAD16").addAction("stroke", "#FFAD16", 0.4, 0.3).addAction("closePath").addAction("beginPath").addAction("moveTo", -0.5/1.5, -0.8/1.5).addAction("lineTo", -0.5/1.5, 0.8/1.5).addAction("stroke", "#FFAD16", 0.4, 0.3).addAction("closePath")
    ).setDescription("[object null object]"),
    new PetalConfig("Large Bullet", 0, 40, 0).setProjectile().setDensity(2).setSize(2.5).setDrawing(
        new Drawing().addAction("beginPath").addAction("moveTo", 1.5/1.5, 0/1.5).addAction("quadraticCurveTo", 1.5/1.5, 1/1.5, -1.5/1.5, 1/1.5).addAction("lineTo", -1.5/1.5, -1/1.5).addAction("quadraticCurveTo", 1.5/1.5, -1/1.5, 1.5/1.5, 0/1.5).addAction("fill", "#C0C0C0").addAction("stroke", "#C0C0C0", 0.4, 0.3).addAction("closePath").addAction("beginPath").addAction("moveTo", -0.4/1.5, -0.8/1.5).addAction("lineTo", -0.4/1.5, 0.8/1.5).addAction("stroke", "#C0C0C0", 0.2, 0.3).addAction("closePath").addAction("beginPath").addAction("moveTo", -0.9/1.5, -0.8/1.5).addAction("lineTo", -0.9/1.5, 0.8/1.5).addAction("stroke", "#C0C0C0", 0.2, 0.3).addAction("closePath")
    ).setDescription("[object null object]"),
    new PetalConfig("Shotgun Pellet", 0, 8, 0).setProjectile().setSize(0.75).setDrawing(
        new Drawing().addAction("beginPath").addAction("circle", 0, 0, 1).addAction("fill", "#484848").addAction("stroke", "#484848", 0.4, 0.3)
    ).setDescription("[object null object]"),
    ...
    new PetalConfig("Seeking Rocket", 0, 20, 0).setProjectile(2000, true, 2, 0.5, null).setExplodes(petalIDOf("Shrapnel"), 3/20).setSize(1.5).setDescription("[object null object]"),
    new PetalConfig("Shrapnel", 0, 18, 0).setProjectile(50, false, 0, 0, 0.96).setDensity(3).setSize(1).setDescription("[object null object]"),
];
petalConfigs.push(...newPetals1);

newPetals1 = [
    new PetalConfig("Pistol", 18, 12, 2.5).setShooter(petalIDOf("Small Bullet"), 4, 30, 0.1).setSize(1).setDescription("A basic firearm."),
    new PetalConfig("SMG", 42, 25, 2.5).setShooter(petalIDOf("Small Bullet"), 2, 30, 0.2).setSize(2).setDrawing(
    ...
    new PetalConfig("Assault Rifle", 68, 20, 4).setShooter(petalIDOf("Medium Bullet"), 4, 45, 0.05).setSize(3).setDrawing(
    ...
    new PetalConfig("Shotgun", 68, 6, 2).setShooter(petalIDOf("Shotgun Pellet"), 14, 30, 0.3, 10).setSize(3).setDrawing(
        new Drawing().addAction("beginPath").addAction("moveTo",-0.7765999826416373,-0.053999998793005946).addAction("lineTo",-0.7765999826416373,0.09009999798610806).addAction("bezierCurveTo",-0.7765999826416373,0.17289999613538384,-0.7026999842934311,0.24009999463334677,-0.6115999863296747,0.24009999463334677).addAction("lineTo",-0.44639999002218245,0.24009999463334677).addAction("bezierCurveTo",-0.35529999205842616,0.24009999463334677,-0.28139999371021984,0.17289999613538384,-0.28139999371021984,0.09009999798610804).addAction("lineTo",-0.28139999371021984,-0.054099998790770785).addAction("stroke","#2d3233",0.1,0).addAction("closePath").addAction("beginPath").addAction("moveTo",-2.1435999520868063,-0.1452999967522919).addAction("bezierCurveTo",-2.1566999517939984,-0.19689999559894203,-2.1182999526523054,-0.2475999944657087,-2.060599953942001,-0.25469999430701135).addAction("lineTo",-0.8776999803818762,-0.40149999102577566).addAction("lineTo",-0.8755999804288149,-0.0139999996870756).addAction("lineTo",-0.9756999781914056,0.029099999349564323).addAction("bezierCurveTo",-1.0571999763697386,0.06419999856501818,-1.1192999749816954,0.12799999713897706,-1.147699974346906,0.20579999540001156).addAction("lineTo",-1.1785999736562374,0.29049999350681904).addAction("bezierCurveTo",-1.1962999732606114,0.3391999924182892,-1.2621999717876315,0.3566999920271337,-1.3059999708086254,0.32439999274909503).addAction("lineTo",-1.3336999701894823,0.30399999320507054).addAction("bezierCurveTo",-1.3703999693691733,0.2769999938085676,-1.4228999681957069,0.2771999938040972,-1.4591999673843388,0.3045999931916595).addAction("lineTo",-1.809299959558994,0.56839998729527).addAction("bezierCurveTo",-1.86599995829165,0.6110999863408506,-1.9523999563604597,0.5845999869331717,-1.9689999559894207,0.5192999883927406).addAction("lineTo",-2.1435999520868063,-0.1452999967522919).addAction("fill","#9f582d").addAction("stroke","#854825",0.1,0).addAction("closePath").addAction("beginPath").addAction("moveTo",-0.050599998869001864,-0.2458999945037067).addAction("lineTo",1.7634999605827033,-0.2458999945037067).addAction("bezierCurveTo",1.818199959360063,-0.2458999945037067,1.862499958369881,-0.20559999540448187,1.862499958369881,-0.15589999651536346).addAction("lineTo",1.862499958369881,-0.06129999862983822).addAction("bezierCurveTo",1.862499958369881,-0.011599999740719787,1.818199959360063,0.02869999935850502,1.7634999605827033,0.02869999935850502).addAction("lineTo",-0.0465999989584088,0.02869999935850502).addAction("lineTo",-0.050599998869001864,-0.2458999945037067).addAction("fill","#3a3e42").addAction("stroke","#2d3233",0.1,0).addAction("closePath").addAction("beginPath").addAction("moveTo",-0.050599998869001864,-0.5566999875567854).addAction("lineTo",2.0540999540872873,-0.5566999875567854).addAction("bezierCurveTo",2.108699952866882,-0.5566999875567854,2.1530999518744647,-0.5163999884575605,2.1530999518744647,-0.4666999895684421).addAction("lineTo",2.1530999518744647,-0.3720999916829169).addAction("bezierCurveTo",2.1530999518744647,-0.32239999279379844,2.108699952866882,-0.28209999369457367,2.0540999540872873,-0.28209999369457367).addAction("lineTo",1.6856999623216689,-0.28209999369457367).addAction("lineTo",1.6858999623171986,-0.03559999920427802).addAction("bezierCurveTo",1.6858999623171986,0.014099999684840415,1.6416999633051457,0.05439999878406522,1.5870999645255506,0.054499998781830046).addAction("lineTo",1.579999964684248,0.054499998781830046).addAction("bezierCurveTo",1.5252999659068882,0.05459999877959487,1.4807999669015408,0.01419999968260524,1.4808999668993057,-0.03559999920427802).addAction("lineTo",1.4810999668948355,-0.28209999369457367).addAction("lineTo",-0.0465999989584088,-0.28209999369457367).addAction("lineTo",-0.050599998869001864,-0.5566999875567854).addAction("fill","#3a3e42").addAction("stroke","#2d3233",0.1,0).addAction("closePath").addAction("beginPath").addAction("moveTo",-0.9497999787703156,-0.49309998897835616).addAction("bezierCurveTo",-0.987499977927655,-0.4761999893561006,-1.009399977438152,-0.43939999017864473,-1.0042999775521457,-0.4013999910280108).addAction("lineTo",-0.9521999787166716,-0.0134999996982515).addAction("bezierCurveTo",-0.9461999788507821,0.03159999929368494,-0.9039999797940255,0.06559999853372572,-0.8538999809138478,0.06559999853372572).addAction("lineTo",-0.053299998808652285,0.06559999853372572).addAction("bezierCurveTo",0.001399999968707434,0.06559999853372572,0.04569999897852528,0.025299999434500918,0.04569999897852528,-0.024399999454617512).addAction("lineTo",0.04549999898299563,-0.499499988835305).addAction("bezierCurveTo",0.04549999898299563,-0.5491999877244235,0.0011999999731777955,-0.5894999868236482,-0.053499998804181936,-0.5894999868236482).addAction("lineTo",-0.5806999870203436,-0.5894999868236482).addAction("bezierCurveTo",-0.6817999847605826,-0.5894999868236482,-0.7816999825276436,-0.56839998729527,-0.8723999805003405,-0.5276999882049859).addAction("lineTo",-0.9497999787703156,-0.49309998897835616).addAction("fill","#3a3e42").addAction("stroke","#2d3233",0.1,0).addAction("closePath").addAction("beginPath").addAction("moveTo",0.25499999430030584,-0.21289999524131417).addAction("bezierCurveTo",0.25499999430030584,-0.2625999941304326,0.2992999933101237,-0.3028999932296574,0.3539999920874834,-0.3028999932296574).addAction("lineTo",1.1607999740540982,-0.3028999932296574).addAction("bezierCurveTo",1.215499972831458,-0.3028999932296574,1.2597999718412758,-0.2625999941304326,1.2597999718412758,-0.21289999524131417).addAction("lineTo",1.2597999718412758,0.05399999879300597).addAction("bezierCurveTo",1.2597999718412758,0.10369999768212439,1.215499972831458,0.1439999967813492,1.1607999740540982,0.1439999967813492).addAction("lineTo",0.35399999208748345,0.1439999967813492).addAction("bezierCurveTo",0.29929999331012375,0.1439999967813492,0.2549999943003059,0.10369999768212439,0.2549999943003059,0.05399999879300597).addAction("lineTo",0.25499999430030584,-0.21289999524131417).addAction("fill","#9f582d").addAction("stroke","#854825",0.1,0).addAction("closePath").addAction("beginPath").addAction("moveTo",0.7655999828875065,-0.16519999630749224).addAction("lineTo",0.7655999828875065,0.01839999958872795).addAction("stroke","#854825",0.1,0).addAction("closePath").addAction("beginPath").addAction("moveTo",0.5455999878048897,-0.16519999630749224).addAction("lineTo",0.5455999878048897,0.01839999958872795).addAction("stroke","#854825",0.1,0).addAction("closePath").addAction("beginPath").addAction("moveTo",0.9855999779701233,-0.16519999630749224).addAction("lineTo",0.9855999779701233,0.01839999958872795).addAction("stroke","#854825",0.1,0).addAction("closePath")
    ).setDescription("A high-damage firearm, at the cost of low range."),
    new PetalConfig("Sniper Rifle", 90, 3, 17.5).setShooter(petalIDOf("Large Bullet"), 40, 70).setSize(3.5).setDrawing(
    ...
    new PetalConfig("Rocket Launcher", 90, 3, 5).setShooter(petalIDOf("Seeking Rocket"), 5/*20*/, 200, 0.1).setSize(1).setDescription("Fires heat-seeking explosive rockets that track enemies."),
