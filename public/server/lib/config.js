...
newPetals1 = [
    new PetalConfig("Pistol", 18, 12, 10).setShooter(petalIDOf("Small Bullet"), 4, 20, 0.1).setSize(1).setDescription("A basic firearm."),
    new PetalConfig("SMG", 45, 25, 10).setShooter(petalIDOf("Small Bullet"), 2, 20, 0.2).setSize(1).setDescription("A high-firerate firearm."),
    new PetalConfig("Assault Rifle", 68, 20, 16).setShooter(petalIDOf("Medium Bullet"), 4, 40, 0.05).setSize(1).setDescription("A well-rounded firearm."),
    new PetalConfig("Shotgun", 68, 6, 8).setShooter(petalIDOf("Shotgun Pellet"), 10, 20, 0.2, 10).setSize(1).setDescription("A high-damage firearm, at the cost of low range."),
    new PetalConfig("Sniper Rifle", 90, 3, 70).setShooter(petalIDOf("Large Bullet"), 25, 60).setSize(1).setDescription("A high-damage firearm, at the cost of low firerate."),
    new PetalConfig("Rocket Launcher", 90, 3, 20).setShooter(petalIDOf("Seeking Rocket"), 4/*20*/, 800, 0.1).setSize(1).setDescription("Fires heat-seeking explosive rockets that track enemies."),

    new PetalConfig("Tank Turret", 90, 3, 20).setShooter(petalIDOf("Seeking Rocket"), 20, 1, 0.1).setSize(1).setDescription(""),
];
petalConfigs.push(...newPetals1);
