        ...
        switch (reader.getUint8()) {
            ...
            case SERVER_BOUND.INPUTS: {
                ...
                if ((flags & 0x40) === 0x40 || (flags & 0x80) === 0x80) {
                    this.body.pointAngle = reader.getFloat32();
                    this.body.pointMagnitude = reader.getFloat32();
                    
                    // this.body.moveAngle = this.body.pointAngle;
                    // this.body.moveStrength = Math.min(1, Math.max(0, this.body.pointMagnitude)) * this.body.speed;
                }
                else {
                    this.body.pointAngle = this.body.moveAngle;
                    this.body.pointMagnitude = 10;
                }
                // END
                // REMOVED
                // if ((flags & 0x40) === 0x40 || (flags & 0x80) === 0x80) {
