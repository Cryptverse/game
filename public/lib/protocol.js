...
export class PetalConfig {
    ...
    // ADDITION
    setShooter(petalID, fireinterval, speed, spread=0, count=1) {
        for (let i = 0; i < this.tiers.length; i++) {
            this.tiers[i].health = this.tiers[0].health;
        }
        this.shooter = {
            petal: petalID,
    ...
    setParticles(petalID) {
        this.particle = petalID;
        return this;
    }
    setProjectile(lifetime=50, seeking=false, turnSpeed=0, acceleration=0, friction=1) {
        this.projectile = {
            lifetime: lifetime,
            seeking: seeking,
            turn: turnSpeed,
            acceleration: acceleration, // Acceration per tick as a percentage
            friction: friction
        }
        return this;
    }
    setExplodes(petalID, damageRatio=1/20, count=20) {
        this.explodes = {
            petal: petalID,
    ...
    setTurret(petalID, offset={x:0,y:0}) {
        this.turret = {
            petal: petalID,
            offset: offset
        }
